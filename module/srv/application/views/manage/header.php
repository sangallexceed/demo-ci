...
<html lang="ja">
	<head>
		...
		<link rel="stylesheet" href="<?= site_url('assets/css/jquery-ui-timepicker-addon.min.css'); ?>">
		<link rel="stylesheet" href="<?= site_url('assets/css/jquery-ui.min.css'); ?>">
		<link rel="stylesheet" href="<?= site_url('assets/css/jquery.timepicker.css'); ?>">
		<link rel="stylesheet" href="<?= site_url('assets/css/jquery.timepicker.css'); ?>">
		<link rel="stylesheet" href="<?= site_url('assets/css/jquery-ui-timepicker-addon.css'); ?>">
		...
		<script src="<?= site_url('assets/js/datepicker-ja.js'); ?>"></script>
		<script src="<?= site_url('assets/js/jquery-ui-timepicker-addon.js'); ?>"></script>
		<script src="<?= site_url('assets/js/jquery-ui-timepicker-ja.js'); ?>"></script>
		<script src="<?= site_url('assets/js/jquery.timepicker.js'); ?>"></script>
		<script src="<?= site_url('assets/js/jquery-ui-timepicker-addon.min.js'); ?>"></script>
